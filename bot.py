...
# Flask serverini ayrı thread-də başlatmaq
t = threading.Thread(target=run_flask)
t.daemon = True
t.start()

# --- BOT NİZAMLAMALARI ---
TELEGRAM_TOKEN = os.environ.get('BOT_TOKEN', '8906009577:AAHuAnl7ze8y2DH2KFVQLXMj7o0ZQCm8fC4')
...
def get_pair_inline_keyboard():
    ...
    buttons = [
        ...
        types.InlineKeyboardButton("🇳🇿 NZD/USD", callback_data="pair_NZD/USD"),
        types.InlineKeyboardButton("💶 EUR/JPY", callback_data="pair_EUR/JPY"),
        types.InlineKeyboardButton("💷 GBP/JPY", callback_data="pair_GBP/JPY"),
